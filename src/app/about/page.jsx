...
const AboutPage = () => {
  ...
  const isExperienceRefInView = useInView(experienceRef, { margin: "-500px" });
        ...
        <div className="p-4 sm:p-8 md:p-12 lg:p-20 xl:p-48 flex flex-col gap-24 md:gap-32 lg:gap-48 xl:gap-64 lg:w-2/3 lg:pr-0 xl:w-1/2">
          ...
          <div className="flex flex-col gap-12 justify-center">
            ...
            <div className="self-end">
              ...
              >
                <path
                  d="M101 2C93.9571 5.807 89.085 11.6146 84.7222 18.3333C70.9076 39.6079 66.3509 61.7416 71.1111 86.5556C74.0804 102.034 78.6378 117.07 82.8889 132.222C85.8373 142.731 89.1621 153.175 88.8333 164.222C88.2683 183.208 80.9482 203 66.3889 215.556C57.8603 222.911 45.9971 229.889 34.3333 229.889C17.0438 229.889 9.63788 203.287 5.77778 190.444C2.14485 178.357 -2.4324 159.204 9.33334 149.778C24.7284 137.444 49.8788 148.893 65 155.333C80.592 161.974 94.305 170.341 106.5 182.111C110.531 186.001 117.909 197.527 121 187.611C126.257 170.746 123.49 150.848 121.556 133.667C121.323 131.603 116.629 115.087 122.5 117.889C129.378 121.172 135.616 126.041 141.444 130.889C144.962 133.815 146.702 137.6 149.444 132.222C152.103 127.01 153.917 121.654 155.222 116C155.948 112.854 157.48 113.819 159.444 115.222C167.009 120.625 169.401 106.912 174.444 104.222C176.885 102.921 181.986 105.019 184.222 105.944C187.353 107.24 187.86 105.898 190.667 104.556C195.587 102.202 215.296 106.812 217 102.222C219.446 95.6303 218.104 85.4975 217.5 79C216.493 68.1717 214.553 57.5836 210.222 47.5556C207.994 42.3964 204.87 37.5921 202 32.7778C198.762 27.3458 203.866 33.836 204.222 34.2222C216.163 47.1787 229.177 58.9821 241.667 71.3889C248.863 78.5371 255.516 86.1525 262.556 93.4444C265.107 96.0879 269.3 101.353 273.056 102.778C274.162 103.198 289.214 75.8854 289.278 75.7778C289.742 74.9918 298.194 61.2985 296.556 60.8889C289.427 59.1069 270.475 69.2583 266.333 71.0556C239.773 82.5802 214.028 95.7766 189 110.333C158.033 128.345 127.757 147.586 100.333 170.667C96.1826 174.16 89.4973 178.005 87 183"
                  stroke="black"
                  stroke-width="3"
